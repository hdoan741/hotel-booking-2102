...
$route['booking/list'] = "booking_controller/booking_list";
$route['booking/delete/(:any)'] = "booking_controller/delete_booking/$1";
$route['booking/update/(:any)'] = "booking_controller/update_booking/$1";
$route['booking/mybooking'] = "booking_controller/mybooking";
$route['mybooking/delete/(:any)'] = "booking_controller/mybooking_delete/$1";
...
$route['hotels/delete/(:any)'] = 'hotels_controller/delete_hotel/$1';
...
$route['complete'] = "booking_controller/complete";
